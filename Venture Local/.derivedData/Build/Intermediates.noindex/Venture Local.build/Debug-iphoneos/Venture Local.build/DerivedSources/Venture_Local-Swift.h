...
#ifndef VENTURE_LOCAL_SWIFT_H
#define VENTURE_LOCAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Venture_Local",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13Venture_Local22ExplorationCoordinator")
@interface ExplorationCoordinator : NSObject
...
@class CLLocation;
@interface ExplorationCoordinator (SWIFT_EXTENSION(Venture_Local)) <CLLocationManagerDelegate>
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC13Venture_Local23QRCaptureViewController")
@interface QRCaptureViewController : UIViewController <AVCaptureMetadataOutputObjectsDelegate>
- (void)viewDidLoad;
